...
public class StateMachine {
    ...
    private static final AtomicBoolean wantStop = new AtomicBoolean(true),
     stateLock = new AtomicBoolean(false), isInfinite = new AtomicBoolean(false);
    ...
    private static final Runnable Man = () -> {
        try {
            ...
            } while (isInfinite.get() && !wantStop.get());
    ...
    public static boolean runMachine(StateMachineDescriptor descriptor) {
        ...
        stateLock.set(true);
        wantStop.set(false);
        isInfinite.set(descriptor instanceof InfiniteStateMachineDescriptor);
